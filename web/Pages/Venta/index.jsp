<%-- 
    Document   : index
    Created on : 27-oct-2020, 23:20:20
    Author     : Eduardo
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-auto" style="border-style: solid;margin-right: 10px;height: 260px;">
                    <iframe src="ServCliente?accion=nuevo" style="height: 100%; width: 100%; border: none;"></iframe>
                </div>
                <div class="col" style="border-style: solid;height: 750px;">
                    <iframe src="ServDetalle?accion=nuevo" style="height: 100%; width: 100%; border: none;"></iframe>
                </div>
            </div>
        </div>
